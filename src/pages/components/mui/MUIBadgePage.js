...
export default function MUIBadgePage() {
  return (
    <>
      <Helmet>
        <title> MUI Components: Badge | Raisin Elixir</title>
      </Helmet>
      ...
      <Container sx={{ my: 10 }}>
        <Masonry columns={{ xs: 1, md: 2 }} spacing={3}>
          ...
          >
            <Badge badgeContent={99} color="error" children={<Iconify icon="eva:email-fill" width={24} />} />
            <Badge badgeContent={100} color="error" children={<Iconify icon="eva:email-fill" width={24} />} />
            <Badge
              badgeContent={1000}
              max={999}
              color="error"
