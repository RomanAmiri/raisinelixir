...
export default function FoundationIconsPage() {
  return (
    <>
      <Helmet>
        <title> Foundations: Icons | Raisin Elixir</title>
      </Helmet>
      ...
      <Container sx={{ my: 10 }}>
        <Stack spacing={3}>
          ...
          <Block title="Local Icons" sx={style}>
            ...
            <SvgColor src="/assets/icons/navbar/ic_dashboard.svg" sx={{ color: 'action.disabled' }} />
            <SvgColor src="/assets/icons/navbar/ic_dashboard.svg" sx={{ color: 'primary.main' }} />
            <SvgColor src="/assets/icons/navbar/ic_dashboard.svg" sx={{ color: 'secondary.main' }} />
