...
import { MegaMenuMobile, MegaMenuDesktopHorizon, MegaMenuDesktopVertical } from '../../../components/mega-menu';
...
export default function DemoMegaMenuPage() {
  return (
    <>
      <Helmet>
        <title> Extra Components: Mega Menu | Raisin Elixir</title>
      </Helmet>
      ...
      <Container sx={{ my: 10 }}>
        ...
        <Stack direction="row" spacing={3} mt={5}>
          ...
          <Image alt="any photo" src={_mock.image.cover(18)} ratio="21/9" sx={{ borderRadius: 1 }} />
        </Stack>
      </Container>
    </>
  );
