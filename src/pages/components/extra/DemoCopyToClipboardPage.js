...
// @mui
import { Box, Card, Stack, Tooltip, Container, TextField, IconButton, Typography, InputAdornment } from '@mui/material';
// hooks
...
export default function DemoCopyToClipboardPage() {
  ...
  return (
    <>
      ...
      <Container sx={{ my: 10 }}>
        <Card sx={{ p: 5 }}>
          <Box display="grid" gridTemplateColumns={{ xs: 'repeat(1, 1fr)', md: 'repeat(2, 1fr)' }} gap={5}>
            <Stack spacing={2}>
